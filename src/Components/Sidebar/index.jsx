            ...
            <div className=''>
                {
                    SidebarData.map((item, index) => (
                        <NavLink to={item.path} key={index} className="link flex items-center mb-2 px-3 py-2 text-primary-gray" activeclassname="active">
                            <div className="icon">{item.icon}</div>
                            <div style={{ display: isOpen ? "block" : "none" }} className="link_text ml-3">{item.title}</div>
                        </NavLink>
                    ))
                }
            </div>
